// mbowolick advent-of-code-2023/day1 attempt
//
...
// can be found by combining the first digit and the last digit (in that
// order) to form a single two-digit number. Example input:
// ----------------------
// 1abc2
// pqr3stu8vwx
// a1b2c3d4e5f
...
func calculateCalibrationValue(line string) int {
	...
	// Split line into an array and iterate and store digit in an array if number
	for i := range line {
		char := string(line[i])
	...
	// Find first and last digit of detected number
	first := numbers[0]
	last := numbers[len(numbers)-1]

	// return concate number
...
func main() {
	...
	// Create an empty slice of type int:
	var calibrationValues []int 
	total_values := 0

	// Initialise input doc
	inputDoc := `9vxfg
	...
	4vmzcrhtdvnm6zfive5pkbhcxj`
	 ...
	 inputLines := strings.Split(inputDoc, "\n")

	 for lineIndex := range inputLines {
		line := inputLines[lineIndex]
		num := calculateCalibrationValue(line)
